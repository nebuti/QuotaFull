...
import 'package:mouse/common/car/vehicle_rent/vehicle_for_house/car_detias_house.dart';
...
class car_Others extends StatefulWidget {
  @override
  State<car_Others> createState() => _car_OthersState();
}

class _car_OthersState extends State<car_Others> {
  bool isFav = false;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
          child: Others_house(isFav: isFav),
        ));
  }
}

class Others_house extends StatefulWidget {
  final bool isFav;
  const Others_house({
    Key? key,
    required this.isFav,
  ...
  @override
  State<Others_house> createState() => _Others_houseState();
}

class _Others_houseState extends State<Others_house> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
