...
class car_va extends StatefulWidget {
  @override
  State<car_va> createState() => _car_vaState();
}

class _car_vaState extends State<car_va> {
  bool isFav = false;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
          child: va_house(isFav: isFav),
        ));
  }
}

class va_house extends StatefulWidget {
  final bool isFav;
  const va_house({
    Key? key,
    required this.isFav,
  ...
  @override
  State<va_house> createState() => _va_houseState();
}

class _va_houseState extends State<va_house> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
