...
class car_min extends StatefulWidget {
  @override
  State<car_min> createState() => _car_minState();
}

class _car_minState extends State<car_min> {
  bool isFav = false;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
          child: min_house(isFav: isFav),
        ));
  }
}

class min_house extends StatefulWidget {
  final bool isFav;
  const min_house({
    Key? key,
    required this.isFav,
  ...
  @override
  State<min_house> createState() => _min_houseState();
}

class _min_houseState extends State<min_house> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
