...
class car_bus extends StatefulWidget {
  @override
  State<car_bus> createState() => _car_busState();
}

class _car_busState extends State<car_bus> {
  bool isFav = false;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
          child: bus_house(isFav: isFav),
        ));
  }
}

class bus_house extends StatefulWidget {
  final bool isFav;
  const bus_house({
    Key? key,
    required this.isFav,
  ...
  @override
  State<bus_house> createState() => _bus_houseState();
}

class _bus_houseState extends State<bus_house> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
