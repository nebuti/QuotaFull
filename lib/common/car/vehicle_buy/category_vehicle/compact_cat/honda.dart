...
class Honda_compact extends StatefulWidget {
  @override
  State<Honda_compact> createState() => _Honda_compactState();
}

class _Honda_compactState extends State<Honda_compact> {
  bool isFav = false;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
          child: Honda_comp(isFav: isFav),
        ));
  }
}

class Honda_comp extends StatefulWidget {
  final bool isFav;
  const Honda_comp({
    Key? key,
    required this.isFav,
  ...
  @override
  State<Honda_comp> createState() => _Honda_compState();
}

class _Honda_compState extends State<Honda_comp> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
