...
class Toyota_compact extends StatefulWidget {
  @override
  State<Toyota_compact> createState() => _Toyota_compactState();
}

class _Toyota_compactState extends State<Toyota_compact> {
  bool isFav = false;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
          child: Toyota_comp(isFav: isFav),
        ));
  }
}

class Toyota_comp extends StatefulWidget {
  final bool isFav;
  const Toyota_comp({
    Key? key,
    required this.isFav,
  ...
  @override
  State<Toyota_comp> createState() => _Toyota_compState();
}

class _Toyota_compState extends State<Toyota_comp> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
