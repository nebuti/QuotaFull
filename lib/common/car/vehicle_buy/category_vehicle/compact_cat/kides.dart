...
class Kides_compact extends StatefulWidget {
  @override
  State<Kides_compact> createState() => _Kides_compactState();
}

class _Kides_compactState extends State<Kides_compact> {
  bool isFav = false;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
          child: Kides_comp(isFav: isFav),
        ));
  }
}

class Kides_comp extends StatefulWidget {
  final bool isFav;
  const Kides_comp({
    Key? key,
    required this.isFav,
  ...
  @override
  State<Kides_comp> createState() => _Kides_compState();
}

class _Kides_compState extends State<Kides_comp> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
