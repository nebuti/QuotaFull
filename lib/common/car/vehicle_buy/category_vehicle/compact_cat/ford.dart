...
class Ford_compact extends StatefulWidget {
  @override
  State<Ford_compact> createState() => _Ford_compactState();
}

class _Ford_compactState extends State<Ford_compact> {
  bool isFav = false;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
          child: Ford_comp(isFav: isFav),
        ));
  }
}

class Ford_comp extends StatefulWidget {
  final bool isFav;
  const Ford_comp({
    Key? key,
    required this.isFav,
  ...
  @override
  State<Ford_comp> createState() => _Ford_compState();
}

class _Ford_compState extends State<Ford_comp> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
