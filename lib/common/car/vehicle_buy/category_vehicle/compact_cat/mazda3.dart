...
class Mazda3_compact extends StatefulWidget {
  @override
  State<Mazda3_compact> createState() => _Mazda3_compactState();
}

class _Mazda3_compactState extends State<Mazda3_compact> {
  bool isFav = false;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
          child: Mazda3_comp(isFav: isFav),
        ));
  }
}

class Mazda3_comp extends StatefulWidget {
  final bool isFav;
  const Mazda3_comp({
    Key? key,
    required this.isFav,
  ...
  @override
  State<Mazda3_comp> createState() => _Mazda3_compState();
}

class _Mazda3_compState extends State<Mazda3_comp> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
