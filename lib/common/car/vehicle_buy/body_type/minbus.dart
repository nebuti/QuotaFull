...
import 'package:mouse/common/car/vehicle_buy/category_vehicle/minbus_cat/minbus.dart';
import 'package:mouse/common/car/vehicle_buy/category_vehicle/minbus_cat/related.dart';

import '../category_vehicle/minbus_cat/Shuttle.dart';
import '../category_vehicle/minbus_cat/minicoach.dart';


class PopularMinbusTitle extends StatelessWidget {
  @override
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          // Image.asset("assets/images/car_minbus.png")
            ],
          ),
...
class PopularMinbusItems extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ListView(
...
class PopularMinbusTiles extends StatelessWidget {
  String name;
  String imageUrl;
  String rating;
