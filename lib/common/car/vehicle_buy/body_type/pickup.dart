...
import 'package:mouse/common/car/vehicle_buy/category_vehicle/pickup_cat/Isuzu.dart';
...
class PopularPickupTitle extends StatelessWidget {
  @override
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          // Image.asset("assets/images/car_pickup.png")
            ],
          ),
...
class PopularPickupItems extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ListView(
...
class PopularPickupTiles extends StatelessWidget {
  String name;
  String imageUrl;
  String rating;
