...
class PopularSedanTitle extends StatelessWidget {
  @override
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          // Image.asset("assets/images/car_sedan.png")
            ],
          ),
...
class PopularSedanItems extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ListView(
...
class PopularSedanTiles extends StatelessWidget {
  String name;
  String imageUrl;
  String rating;
