...
import 'package:mouse/common/house/house_data.dart';
import '../../../../bottum.dart';
import 'house_detias.dart';


class Kolfe_Keranio  extends StatelessWidget {
  @override
...
class Kolfe_Keraniolist extends StatefulWidget {
  @override
  _Kolfe_KeraniolistState createState() => _Kolfe_KeraniolistState();
}

class _Kolfe_KeraniolistState extends State<Kolfe_Keraniolist> {
