...
import 'package:mouse/common/house/House_rent/House_In_A.A/dropdown_In.dart';
import 'package:mouse/common/house/House_rent/House_Out_A.A/dropdown_Out.dart';
...
class homepage_rent extends StatefulWidget {
  @override
  _homepage_rentState createState() => _homepage_rentState();
}
...
class _homepage_rentState extends State<homepage_rent> {
  List<String> carList = [
    'Orange',
    'Berries',
    'Lemons',
        ...
        body: Column(children: [
          Container(
              ...
              child: Column(children: [
                ...
                SizedBox(height: 10),
                Text(
                  "wellcome to rental house station",
                  style: TextStyle(
                      fontSize: 22,
                      fontWeight: FontWeight.bold,
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.pushReplacement(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) => DropDown_In_rent()));
                                    //After successful login we will redirect to profile page. Let's create profile page now
                                  },
                                ),
                              ),
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.pushReplacement(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) => DropDown_out_rent()));
                                    //After successful login we will redirect to profile page. Let's create profile page now
                                  },
                                ),
                              ),
