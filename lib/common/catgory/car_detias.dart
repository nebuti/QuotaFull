...
import 'package:mouse/common/catgory/slide.dart';
...
class DetailsScreen_car extends StatefulWidget {
  final Car car;

  const DetailsScreen_car({
    Key? key,
    required this.car, 
  }) : super(key: key);
  @override
  _DetailsScreen_carState createState() => _DetailsScreen_carState();
}

class _DetailsScreen_carState extends State<DetailsScreen_car> {
  @override
