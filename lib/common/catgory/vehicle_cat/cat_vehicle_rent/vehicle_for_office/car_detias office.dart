...
import 'package:mouse/common/car/vehicle_rent/vehicle_for_office/car_office.dart';
...
class DetailsScreen_office extends StatefulWidget {
  final Car car;

  const DetailsScreen_office({
    Key? key,
    required this.car, 
  }) : super(key: key);
  @override
  _DetailsScreen_officeState createState() => _DetailsScreen_officeState();
}

class _DetailsScreen_officeState extends State<DetailsScreen_office> {
  @override
              ...
              leading: IconButton(
                  ...
                  onPressed: () {
                    Navigator.pushReplacement(context,
                        MaterialPageRoute(builder: (context) => car_office()));
                  }),
            ),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
