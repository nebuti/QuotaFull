...
import 'package:mouse/common/catgory/vehicle_cat/cat_vehicle_buy/vehicle_for_house/car_house.dart';
import 'package:mouse/common/catgory/vehicle_cat/cat_vehicle_buy/vehicle_for_office/car_office.dart';
import 'package:mouse/common/catgory/vehicle_cat/cat_vehicle_buy/vehicle_for_work/car_work.dart';
...
class car_buy extends StatefulWidget {
  @override
  _car_buyState createState() => _car_buyState();
}
...
class _car_buyState extends State<car_buy> {
  List<String> carList = [
    'Orange',
    'Berries',
    'Lemons',
