...
import 'package:mouse/common/catgory/house_cat/cat_house_buy/houselist/house_live/homepage_houslist.dart';
import 'package:mouse/common/catgory/house_cat/cat_house_buy/houselist/house_office/homepage_houslist.dart';
import 'package:mouse/common/catgory/house_cat/cat_house_buy/houselist/house_work/homepage_houslist.dart';
import 'package:mouse/grid_search.dart';
import 'package:mouse/main.dart';

class pagebuy_house extends StatefulWidget {
  @override
  _pagebuy_houseState createState() => _pagebuy_houseState();
}
...
class _pagebuy_houseState extends State<pagebuy_house> {
  List<String> carList = [
    'Orange',
    'Berries',
    'Lemons',
