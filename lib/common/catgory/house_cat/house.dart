...
import 'package:mouse/common/catgory/house_cat/cat_house_buy/pagebuy_house.dart';
import 'package:mouse/common/catgory/house_cat/cat_house_rent/pagerent_house.dart';
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) =>pagerent_house ()));
                              //After successful login we will redirect to profile page. Let's create profile page now
                            },
                          ),
                        ),
